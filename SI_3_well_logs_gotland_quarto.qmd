...
#| warning: false
#| echo: true
#| fig.cap: "Figure 4B.  correlation lines drawn between the correlation points. B. The well-logs along the A’-A’’ transect and their DBA-derived correlation points and lines. The X-axis is kilometres along the transect. The normalized logs are plotted with the same amplitude scale, while maintaining their distance along the profile."
#plot all the correlations lines in the transect ####
{
layout.matrix <- matrix(1,
                        nrow = 1,
