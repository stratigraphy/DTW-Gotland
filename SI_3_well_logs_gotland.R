...
# change out 
setwd("D:/Phd/documents/Altajme/DTW_paper/well_logs/SI_4_logs_used")
# Set the parent directory
parent_dir <- "D:/Phd/documents/Altajme/DTW_paper/well_logs/SI_4_logs_used"
...
well_tops_rotated <- read.csv("D:/Phd/documents/Altajme/DTW_paper/well_logs/well_tops_rotated.csv")
well_tops_rotated
...
for (i in 1:ncol(y_vals)) {
  for (j in 1:(nrow(well_tops_rotated_2))) {
...
las = read.las("D:/Phd/documents/Altajme/DTW_paper/well_logs/SI_4_logs_used/logs_SI_2/GRÖTLINGBO-2/Sc23427-2219.las", flatten=TRUE)
GB_2_log <- as.data.frame(las$log$data)

las = read.las("D:/Phd/documents/Altajme/DTW_paper/well_logs/SI_4_logs_used/logs_SI_2/GROTLINGBO-1/GROTLINGBO-1_FDC_Sc23427-2851.las", flatten=TRUE)
GB_1_log <- as.data.frame(las$log$data)

setwd("D:/Phd/documents/Altajme/DTW_paper/well_logs/SI_4_logs_used/logs_SI_2")
Kauparve_1_RES <- read.csv("Kauparve_1_RES.csv")
...
Kauparve_1_RES <- linterp(Kauparve_1_RES, dt = 0.1)
graphics.off()

Grotlingbo_2_Res <- read.csv("Grotlingbo_2_Res_2.csv")
...
graphics.off()
Kauparve_1_GR <- read.csv("Kauparve_1_GR.csv")
Kauparve_1_GR <- Kauparve_1_GR[, c(2, 3)]
